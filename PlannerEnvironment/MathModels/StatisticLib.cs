...
namespace Baffa.MathModels
{
    public class StatisticLib
    {
        ...
        public static double[][] randomRejection(int m, int n, Function fun,
                double maxFun, double min, double max)
        {
            double[][] A = new double[m][n];
            for (int i = 0; i < A.Length; i++)
                for (int j = 0; j < A[i].Length; j++)
        ...
        */
        ...
        {
            double var;
            int degrees = (v.Length - 1); // m population, m-1 sample
            int m = v.Length;
            double c;
            double s;
            c = 0;
        ...
        public static double[] variance(double[][] v)
        {
            ...
            int degrees = (m - 1); // m population, m-1 sample
            double c;
            double s;
            for (int j = 0; j < n; j++)
            {
        ...
        */
        ...
        public static double[] histogram(double[] values, double min, double max,
                int n)
        {
            double[] _bounds = bounds(values, min, max, n);
            return histogram(values, _bounds);
        }
        ...
        private static double[] bounds(double[] values, double min, double max,
                int n)
        {
        ...
        public static String percFormat(double a)
        {
            return percFormat(a, 1);
        }

        public static String percFormat(double a, int b)
        {
            double dec = Math.Pow(10, b);
            if (dec == 0)
                dec = 1;

            return (((double)Math.Round((a) * (100 * dec))) / dec) + "%";
        }
