...
public class CCI extends PluginAbstract implements ActionListener {
	...
	public String[] calculateBuySellMethod1() {
		...
		System.out.println("CCI1\tResultado\t"
				+ org.baffa.StatisticLib.percFormat(percTotal, 2));

		if (percTotal > 0)
			System.out.println("CCI1\tResultado\tLUCRO\n");
		else
			System.out.println("CCI1\tResultado\tPREJUIZO\n");
	...
	public String[] calculateBuySellMethod2() {
		...
		System.out.println("CCI2\tResultado\t"
				+ org.baffa.StatisticLib.percFormat(percTotal, 2));

		if (percTotal > 0)
			System.out.println("CCI2\tResultado\tLUCRO\n");
		else
			System.out.println("CCI2\tResultado\tPREJUIZO\n");
	...
	public void showConfig() {
		...
		confFrame.setName("CCI Configuration");
		confFrame.setTitle("CCI Configuration");
		confFrame
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() instanceof JButton) {
			if (((JButton) e.getSource()).getText() == "Cancel") {
				...
				factor = ((Double) spFactor.getValue()).doubleValue();
	...
	Container getSettingsContainer() {
		...
		Dimension spDimension = new Dimension(80, 20);
		...
		lFactor.setMinimumSize(lDimension);
		lFactor.setPreferredSize(lDimension);
		lFactor.setText("Factor: ");
		...
		container1.add(lFactor, new GBC(0, 1, 1, 1));
		...
		spFactor = new JSpinner(new SpinnerNumberModel(factor, // initial
				// value
				0.0095, // min
				1, // max
				0.005));
		spFactor.setMinimumSize(spDimension);
		spFactor.setPreferredSize(spDimension);
		...
		container1.add(spFactor, new GBC(1, 1, 1, 1));
