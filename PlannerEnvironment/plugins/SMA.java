...
public class SMA extends PluginAbstract implements ActionListener {
	...
	public String[] calculateBuySellMethod1() {
		...
		System.out.println("SMA1\tResultado\t"
				+ org.baffa.StatisticLib.percFormat(percTotal, 2));

		if (percTotal > 0)
			System.out.println("SMA1\tResultado\tLUCRO\n");
		else
			System.out.println("SMA1\tResultado\tPREJUIZO\n");
	...
	public String[] calculateBuySellMethod2() {
		...
		System.out.println("SMA2\tResultado\t"
				+ org.baffa.StatisticLib.percFormat(percTotal, 2));

		if (percTotal > 0)
			System.out.println("SMA2\tResultado\tLUCRO\n");
		else
			System.out.println("SMA2\tResultado\tPREJUIZO\n");
	...
	public String[] calculateBuySellMethod3() {
		...
		System.out.println("SMA3\tResultado\t"
				+ org.baffa.StatisticLib.percFormat(percTotal, 2));

		if (percTotal > 0)
			System.out.println("SMA3\tResultado\tLUCRO\n");
		else
			System.out.println("SMA3\tResultado\tPREJUIZO\n");
	...
	public void showConfig() {
		...
		confFrame.setName("SMA Configuration");
		confFrame.setTitle("SMA Configuration");
		confFrame
	...
	Container getShortLong() {
		...
		JCheckBox chkShortLong = new JCheckBox("Use Long Sma Only", useLongOnly);
	...
	Container getShortContainer() {
		...
		container1 = createFrame(container1, "Short SMA");
	...
	Container getLongContainer() {
		...
		container2 = createFrame(container2, "Long SMA");
